...
def format_rewards_field_value(rewards: Dict[str, int]) -> str:
    ...
    sort_priority = {
        "Schildmaid": 0, "Walküren-Scharfschützin": 0, "Beschützer des Nordens": 0, "Walküren-Waldläuferin": 0, # Troops
        "Lose": 1, # Tickets
        "Rubine": 2, # Rubies
...
async def spintest(interaction: discord.Interaction):
    ...
    try:
        ...
        traceback.print_exc()
        await interaction.followup.send("❌ Fehler beim Generieren der Testausgabe.", ephemeral=True)
